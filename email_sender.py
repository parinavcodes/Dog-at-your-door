...
def emailer():
    load_dotenv()
    emails = []
    with open(resource_path("email_token.pickle"), 'rb') as token:  #token is generated from googleapiclient and the credentials are stored in email_token.pickle 
    ...
    mime_message['subject'] = "Your dog is at the door"
